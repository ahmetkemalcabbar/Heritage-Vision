...
class VGGUNET16(nn.Module):
    def __init__(self, features=64, in_channels=3, out_channels=1):
        ...
        self.down2 = nn.Sequential(
            ...
            nn.Conv2d(features*4, features*4, kernel_size=3, stride=1, padding=1, bias=False),
        ...
        self.down3 = nn.Sequential(
            ...
            nn.Conv2d(features*8, features*8, kernel_size=3, stride=1, padding=1, bias=False),
        ...
        self.down4 = nn.Sequential(
            ...
            nn.Conv2d(features*16, features*16, kernel_size=3, stride=1, padding=1, bias=False),
